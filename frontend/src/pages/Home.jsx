            ...
            <div className=" w-full  h-screen flex gap-8">
                <div className="w-1/2 pl-20 flex gap-8 items-center custom-img">
                    <div className='w-full'>
                        ...
                        <h3 className='text-7xl font-bold text-black mt-5'>Made Easy through</h3>
                        <h3 className='text-7xl font-bold text-[#ADFA1D] mt-5 flex items-center gap-4'>Decision Driver
